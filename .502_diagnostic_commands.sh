...
ssh hilovivo-aws 'cd ~/crypto-2.0 && docker compose --profile aws ps frontend-aws'
ssh hilovivo-aws 'cd ~/crypto-2.0 && docker compose --profile aws up -d frontend-aws'
...
ssh hilovivo-aws 'cd ~/crypto-2.0 && docker compose --profile aws logs --tail=50 frontend-aws'
