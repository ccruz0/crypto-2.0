#!/usr/bin/env python3
"""
Servidor con datos mock realistas de tu cartera
"""
...
def account_balance_route():
    """Endpoint para obtener el balance de la cuenta (datos realistas)"""
...
def open_orders_route():
    """Endpoint para obtener órdenes abiertas (datos realistas)"""
...
def order_history_route():
    """Endpoint para obtener historial de órdenes (datos realistas)"""
...
def get_instruments():
    """Get trading instruments (datos realistas)"""
    return jsonify({
        "instruments": [
...
def health():
    return jsonify({
        "status": "healthy",
        "message": "Servidor con datos realistas de tu cartera",
        "portfolio_total": REALISTIC_PORTFOLIO["total_usd"],
        "account_count": len(REALISTIC_PORTFOLIO["accounts"])
    })

if __name__ == '__main__':
    print("🚀 Iniciando servidor con datos realistas de tu cartera...")
