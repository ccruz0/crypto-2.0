...
# Deploy Expected TP Details modal fix to AWS
...
echo "🚀 Deploying Expected TP Details modal fix to AWS..."
...
docker compose --profile aws logs --tail=50 frontend-aws | grep -i "ready\|error\|compiled" || true
...
echo "2. Navigate to Expected TP tab"
echo "3. Click 'View Details' on any symbol"
