#!/usr/bin/env python3
"""
Servidor con timestamp correcto para 2024 (no 2025)
"""
...
def get_correct_2024_timestamp():
    """Obtener timestamp correcto para 2024 (no 2025)"""
    # El sistema está en 2025, pero debería estar en 2024
    # Restar exactamente 1 año (365 días en segundos)
    current_time = time.time()
    correct_time = current_time - (365 * 24 * 60 * 60)  # Restar 1 año
    timestamp = int(correct_time * 1000)
    
    logger.info(f"🕐 Sistema dice: {datetime.fromtimestamp(current_time)}")
...
def make_authenticated_request(method, params=None):
    """Realizar petición autenticada con timestamp de 2024"""
    try:
        nonce = get_correct_2024_timestamp()
...
def health():
    return jsonify({
        ...
        "message": "Conectándose a TU cartera real con timestamp de 2024"
    })

if __name__ == '__main__':
    print("🚀 Iniciando servidor con timestamp de 2024...")
    print("📡 Endpoint: http://localhost:8009/api")
    print("✅ Credenciales reales configuradas")
    print("🕐 Timestamp corregido de 2025 a 2024")
