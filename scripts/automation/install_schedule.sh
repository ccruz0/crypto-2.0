...
JARVIS_AUTO_REMEDIATION_ENABLED=false
JARVIS_AUTO_REMEDIATION_DRY_RUN=true
JARVIS_AGENT_INVESTIGATION_ONLY=true
JARVIS_REMEDIATION_MAX_ATTEMPTS=3
JARVIS_REMEDIATION_GRACE_SECONDS=30
