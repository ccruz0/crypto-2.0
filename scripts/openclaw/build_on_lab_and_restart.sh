...
run_cmd="sudo docker run -d --restart unless-stopped -p 8080:18789 -e OPENCLAW_ALLOWED_ORIGINS=$OPENCLAW_ALLOWED_ORIGINS -e OPENCLAW_TRUSTED_PROXIES=$OPENCLAW_TRUSTED_PROXIES -e OPENCLAW_CONFIG_PATH=$OPENCLAW_CONFIG_PATH -v $OPENCLAW_CONFIG_DIR:$OPENCLAW_CONFIG_DIR -v $OPENCLAW_HOME_DIR:/home/node/.openclaw -v $ATP_REPO_PATH:/home/node/.openclaw/workspace:ro -v $OPENCLAW_HOME_DIR/agents:/home/node/openclaw/agents --name openclaw openclaw:local"
