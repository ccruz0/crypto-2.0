...
if [[ "$STATUS" == "Online" || "$FORCE" == "force" ]]; then
  ...
  COMMAND_ID=$(aws ssm send-command \
    ...
    --parameters 'commands=["set -e","cd /home/ubuntu/automated-trading-platform 2>/dev/null || cd /home/ubuntu/crypto-2.0 || exit 1","git pull origin main 2>/dev/null || true","NOTION_TASK_DB=eb90cfa139f94724a8b476315908510a ./scripts/run_notion_task_pickup.sh"]' \
    --timeout-seconds 120 \
