#!/usr/bin/env python3
"""
Generator script to create scripts/verify_ec2_ip_and_health.sh
This avoids paste truncation issues when creating the script on EC2.
Usage: python3 scripts/write_verify_ec2_ip_and_health.py
"""
...
def main():
    ...
    target_script = os.path.join(script_dir, 'verify_ec2_ip_and_health.sh')
    
    print(f"Generating {target_script}...")
    ...
    print(f"  ./scripts/verify_ec2_ip_and_health.sh")
