#!/usr/bin/env python3
"""
Servidor multi-exchange para datos de criptomonedas
Obtiene datos de múltiples fuentes: Binance, CoinGecko, CoinMarketCap, Crypto.com
"""
...
def get_binance_data():
    ...
    try:
        ...
        crypto_data = []
        for ticker in data[:20]:  # Primeros 20
...
def get_cryptocom_data():
    ...
    try:
        ...
        if "result" in result and "data" in result["result"]:
            for ticker in result["result"]["data"][:20]:
...
def get_crypto_data():
    ...
    try:
        ...
        aggregated_data = aggregate_crypto_data()
...
if __name__ == '__main__':
    print("🚀 Iniciando servidor multi-exchange para datos de crypto...")
    print("📡 Fuentes: Binance, CoinGecko, Crypto.com")
